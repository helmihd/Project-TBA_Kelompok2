...
def open_addition_window():    
    ...
    def perform_addition():
        ...
        while q not in [3, 5, 7, 9, 10]:
            ...
            label_track_1_arrow.config(text="Track 1: " + ''.join(str(x) for x in Track_1_arrow))
    ...
    label_track_1_arrow = ttk.Label(addition_window, text="         ")
    label_track_1_arrow.pack()
    
    label_track_2 = ttk.Label(addition_window, text="Track 2: ")
    label_track_2.pack()
    
    label_track_2_arrow = ttk.Label(addition_window, text="         ")
    label_track_2_arrow.pack()
